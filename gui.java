...
public class Gui extends JFrame implements ActionListener{
    ...
    public void openFrame1(){
        ...
        scene1Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene1path);
        scene2Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene2path);
        scene3Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene3path);
        scene4Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene4path);
        scene5Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene5path);
        scene6Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene6path);
        scene7Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene7path);
        scene8Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene8path);
        scene9Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene9path);
        scene10Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene10path);
        scene11Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene11path);
        scene12Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene12path);
        scene13Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene13path);
        scene14Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene14path);
        scene15Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene15path);
        scene16Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene16path);
        scene17Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene17path);
        scene18Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene18path);
        scene19Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene19path);
        scene20Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene20path);
        scene21Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene21path);
        scene22Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene22path);
        scene23Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene23path);
        scene24Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene24path);
        scene25Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene25path);
        scene26Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene26path);
        scene27Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene27path);
        scene28Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene28path);
        scene29Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene29path);
        scene30Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene30path);
        scene31Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene31path);
        scene32Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene32path);
        scene33Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene33path);
        scene34Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene34path);
        scene35Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene35path);
        scene36Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene36path);
        scene37Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene37path);
        scene38Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene38path);
        scene39Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene39path);
        scene40Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene40path);
        scene41Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene41path);
        scene42Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene42path);
        scene43Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene43path);
        scene44Image = importImage(FRAME_WIDTH, FRAME_HEIGHT, scene44path);
        ...
        scene1Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene2Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene3Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene4Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene5Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene6Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene7Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene8Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene9Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene10Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene11Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene12Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene13Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene14Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene15Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene16Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene17Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene18Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene19Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene20Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene21Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene22Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene23Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene24Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene25Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene26Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene27Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene28Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene29Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene30Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene31Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene32Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene33Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene34Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene35Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene36Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene37Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene38Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene39Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene40Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene41Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene42Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene43Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
        scene44Image.setBounds(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
